...
import TimerRush from "../Apps/TimerRush";
...
const Desktop = ({ openedApps, closeApp }: DesktopProps) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col-2 justify-between">
        ...
        <div className="relative flex-col pt-13 gap-4 px-6">
      ...
      {showTimer && <TimerRush onClose={() => setShowTimer(false)} />}

      {openedApps.includes("Photobooth") && (
        <Photobooth onClose={() => closeApp("Photobooth")} />
      )}
